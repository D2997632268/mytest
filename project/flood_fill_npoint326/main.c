...
//                       }
                       ...
                       //-----------326test------------------//
                       position = pre_X[4]>flood_x1[flood_con1-1]?flood_x1[flood_con1-1]:pre_X[4];
                       printf("position=%d\n", position);
                       //垂直扫描第一条线
                       int autoXY[2] = {0, 0};
...
//                           printf("2a=%d, 2b=%d\n", aa,bb );
                       ...
                       int flood_y2[width];
                       int flood_num2=0;
                       flood_fill_seed(pic, ROW, ay[1]+ay_width[2]/2, nextXu, nextYu, book,flood_x2,flood_y2,&flood_num2);
//                       printf("pos[0]=%d, pos[1]=%d\n", pos[0], pos[1]);
