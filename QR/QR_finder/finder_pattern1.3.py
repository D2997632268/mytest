...
def FloodFill_Jinshan(image,x,y):
    ...
    # cv2.circle(imgCopy2, (k[a][0], k[a][1]), 1, (255, 0, 0), 1)#rect[0]
    # cv2.putText(imgCopy2, '0', (k[a][0]-10, k[a][1]), cv2.FONT_HERSHEY_SIMPLEX, 0.25, (255,0,0), 1, cv2.LINE_AA)

    # rect[0] = [k[a][0], k[a][1]]

    # cv2.circle(imgCopy2, (k[d][0], k[d][1]), 1, (255, 0, 0), 1)#rect[1] 
    # cv2.putText(imgCopy2, '1', (k[d][0]+10, k[d][1]), cv2.FONT_HERSHEY_SIMPLEX, 0.25, (255,0,0), 1, cv2.LINE_AA)

    # rect[1] = [k[d][0], k[d][1]]

    # cv2.circle(imgCopy2, (k[b][0], k[b][1]), 1, (255, 0, 0), 1)#rect[2]
    # cv2.putText(imgCopy2, '2', (k[b][0]+10, k[b][1]), cv2.FONT_HERSHEY_SIMPLEX, 0.25, (255,0,0), 1, cv2.LINE_AA)

    # rect[2] = [k[b][0], k[b][1]]

    # cv2.circle(imgCopy2, (k[c][0], k[c][1]), 1, (255, 0, 0), 1)#rect[3]
    # cv2.putText(imgCopy2, '3', (k[c][0]-10, k[c][1]), cv2.FONT_HERSHEY_SIMPLEX, 0.25, (255,0,0), 1, cv2.LINE_AA)
            ...
            for xW in range(0, len(Xwidth) - 4):
                ...
                if ok == 1:  # 水平扫描结束
                    ...
                    if XX != [] and y != [] :
                        ...
                        # print('len',len(k))
                        print('y=',y)
                        K,rect = FloodFill_Jinshan(image,XX[0],y)
                        # kk.clear()
                        print('sum-K',len(K))
